...
var author$project$Main$Set1ms = {$: 'Set1ms'};
var elm$core$Basics$False = {$: 'False'};
var author$project$Main$initialModel = {count: 1, isOver: false, number: 35, setTimer: author$project$Main$Set1ms};
...
var author$project$Main$primeArray = elm$core$Array$fromList(
	_List_fromArray(
		[2, 3, 5, 7, 11, 13, 17]));
...
var author$project$Main$nextComposite = F2(
	function (lim, n) {
		return A2(
				...
				elm$core$List$map(
					function (i) {
						return A2(
							...
							1,
							A2(elm$core$Array$get, i, author$project$Main$primeArray));
					}),
				A2(elm$core$List$foldl, elm$core$Basics$mul, 1)),
			A2(
				elm$random$Random$list,
				n,
				A2(elm$random$Random$int, 0, lim)));
	});
var author$project$Main$SetTimer = function (a) {
	return {$: 'SetTimer', a: a};
};
...
var author$project$Main$subscription = function (model) {
	if (model.isOver) {
		...
		var _n0 = model.setTimer;
		if (_n0.$ === 'Set1ms') {
			return A2(elm$time$Time$every, 20, author$project$Main$SetTimer);
		} else {
			return elm$core$Platform$Sub$batch(
				_List_fromArray(
					[
						A2(elm$time$Time$every, 7980, author$project$Main$Timeout),
						elm$browser$Browser$Events$onKeyDown(author$project$Main$keyDecoder)
					]));
		}
	}
};
var author$project$Main$Set8s = {$: 'Set8s'};
var author$project$Main$kindsOfButtons = function (n) {
	return 4 * (((n / 100) | 0) + 1);
};
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Pressed':
				var n = msg.a;
				return (!A2(elm$core$Basics$modBy, n, model.number)) ? ((((model.number / n) | 0) === 1) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{count: model.count + 1}),
					A2(
						...
						A2(
							author$project$Main$nextComposite,
							author$project$Main$kindsOfButtons(model.count) - 1,
							((model.count / 5) | 0) + 2))) : _Utils_Tuple2(
					_Utils_update(
						model,
						{number: (model.number / n) | 0}),
			...
			case 'SetTimer':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{setTimer: author$project$Main$Set8s}),
					elm$core$Platform$Cmd$none);
			case 'Next':
				var q = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{number: q, setTimer: author$project$Main$Set1ms}),
					elm$core$Platform$Cmd$none);
			case 'Continue':
...
var author$project$Main$makeButton = function (n) {
	return A2(
		elm$html$Html$button,
		_List_fromArray(
			[
				elm$html$Html$Events$onClick(
				author$project$Main$Pressed(n))
			]),
		_List_fromArray(
			[
				elm$html$Html$text(
...
var author$project$Main$numSys = function (n) {
	var _n0 = A2(elm$core$Basics$modBy, 10, n);
	switch (_n0) {
		case 1:
			return 'st';
		case 2:
...
var author$project$Main$timeLimitBar = function (model) {
	var _n0 = model.setTimer;
	if (_n0.$ === 'Set8s') {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$id('timelimit')
				]),
			_List_fromArray(
				[
					A2(
	...
	return model.isOver ? A2(
		...
		_List_fromArray(
			[
				...
				elm$html$Html$text(
				'Scores : ' + elm$core$String$fromInt(model.count - 1)),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				A2(
				elm$html$Html$button,
				_List_fromArray(
			...
			_List_fromArray(
				[
					...
					A2(
						...
						A2(
							elm$core$String$append,
							author$project$Main$numSys(model.count),
							' problem'))),
					A2(elm$html$Html$br, _List_Nil, _List_Nil),
					elm$html$Html$text(
					elm$core$String$fromInt(model.number)),
					A2(elm$html$Html$br, _List_Nil, _List_Nil),
					author$project$Main$timeLimitBar(model),
					A2(elm$html$Html$br, _List_Nil, _List_Nil)
				]),
			A2(
				elm$core$List$map,
				...
				A2(
					elm$core$List$take,
					author$project$Main$kindsOfButtons(model.count),
					elm$core$Array$toList(author$project$Main$primeArray)))));
};
		...
		init: function (_n0) {
			return _Utils_Tuple2(
				...
				A2(
					elm$random$Random$generate,
					author$project$Main$Next,
					A2(author$project$Main$nextComposite, 3, 2)));
		},
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Pressed":["Basics.Int"],"Continue":[],"Next":["Basics.Int"],"SetTimer":["Time.Posix"],"Timeout":["Time.Posix"],"None":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}}}}})}});}(this));